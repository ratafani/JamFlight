...
class pageViewController: UIPageViewController, UIPageViewControllerDelegate, UIPageViewControllerDataSource {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        orderedViewControllers.append(self.newVc(viewController: "intro1"))
        orderedViewControllers.append(self.newVc(viewController: "intro2"))
        orderedViewControllers.append(self.newVc(viewController: "intro3"))
